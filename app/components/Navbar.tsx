...
export default function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full bg-[#0f0f14] border-b border-white/10">
            ...
            {mobileOpen && (
                <div className="md:hidden border-t border-white/10 bg-[#0f0f14] px-4 py-4 space-y-1">
