            ...
            <div className="w-auto flex flex-col pl-5 md:pl-20 lg:pl-40 animate-slide-in-left">
                <nav className="w-full max-w-md flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <span className="text-lg font-semibold text-gray-800" style={{ fontFamily: "Poppins, sans-serif" }}>
                            Kumimi
                        </span>
                    </div>
                    <div className="flex items-center gap-4 text-sm">
                        <Link href="/" className="text-gray-500 hover:text-[#825d21] font-semibold transition-colors" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
                            Home
                        </Link>
                        <Link href="/register" className="text-[#36656B] font-semibold hover:text-green-700 transition-colors" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
                            Join
                        </Link>
                    </div>
                </nav>
                    ...
                    <div className="space-y-4">
                        <form className="space-y-4">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <a href="/forgot-password" className="text-[#825d21] hover:underline font-medium" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
                                    Forgot Password?
                                </a>
                            </div>
                        ...
                        <div className="flex justify-center items-center text-sm gap-2 pt-2">
                            <span className="text-gray-500" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>Don't have an account?</span>
                            <Link href="/client/register" className="text-[#825d21] cursor-pointer font-semibold hover:underline transition-all duration-300">
                                Sign Up
                            </Link>
                        </div>
                    </div>
