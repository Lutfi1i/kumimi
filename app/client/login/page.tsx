            ...
            <div className="w-auto flex flex-col pl-5 md:pl-20 lg:pl-40 animate-slide-in-left">
                <nav className="w-full max-w-md flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                        <a href="/" className="text-gray-500 hover:text-[#825d21] font-semibold transition-colors" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
                            Home
                        </a>
                        <a href="/register" className="text-[#36656B] font-semibold hover:text-green-700 transition-colors" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
                            Join
                        </a>
                    </div>
                </nav>
                ...
                <div className="w-full max-w-md gap-6 justify-center md:justify-center lg:justify-start flex flex-col mt-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-center items-center text-sm gap-2 pt-2">
                            ...
                            <a href="/client/register" className="text-[#825d21] cursor-pointer font-semibold hover:underline transition-all duration-300">
                                Sign Up
                            </a>
                        </div>
                    </div>
